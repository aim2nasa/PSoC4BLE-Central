...
void application_start(void)
{
    ...
    wiced_bt_stack_init(ex01scanconnect_management_callback, &wiced_bt_cfg_settings, wiced_bt_cfg_buf_pools);
}
...
void ex01scanconnect_reset_device( void )
{
...
wiced_bt_dev_status_t ex01scanconnect_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_bt_dev_register_hci_trace(ex01scanconnect_trace_callback);
#endif
...
#if 0
        if (ex01scanconnect_read_link_keys( &p_event_data->paired_device_link_keys_request ))
        {
...
void ex01scanconnect_trace_callback( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data )
{
